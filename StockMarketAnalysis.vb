...
'Define variable of the worksheet to excute the code in all work sheets at once in the workbook
...
For Each ws In Worksheets
    ...
    EndRow = ws.Cells(Rows.Count, "A").End(xlUp).Row
        ...
        'For each Ticker summarize and loop 
        For i = 2 To EndRow
            ...
            ' Get the value first day open 
            
            year_open = ws.Cells(previous_i, 3).Value
            year_close = ws.Cells(i, 6).Value
            
            ' A for loop to sum the total stock volume using vol 
...
'The second summary table
    ...
    ' Assign names for max increase,greatest decrease, and  greatest volume
    ...
    'Get max increase, greatest increase, and  greatest volume Ticker name
